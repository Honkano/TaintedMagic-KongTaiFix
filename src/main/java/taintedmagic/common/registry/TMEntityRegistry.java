...
public class TMEntityRegistry {
    ...
    public static void initEntities() {
        int id = 0;
        EntityRegistry
            .registerModEntity(EntityDarkMatter.class, "EntityDarkMatter", id++, TaintedMagic.instance, 64, 21, true);
        EntityRegistry
            .registerModEntity(EntityHomingShard.class, "EntityHomingShard", id++, TaintedMagic.instance, 64, 3, true);
        EntityRegistry
