...
public class ResearchRegistry {
    ...
    public static void initResearch() {
        ...
        r.setParents("SHADOWMETAL", "CAP_void", "PRIMPEARL")
            .setConcealed()
            .registerResearchItem();

        r = new TMResearchItem(
            "SHADOWCLOTH",
            new AspectList().add(Aspect.CLOTH, 1)
                .add(Aspect.DARKNESS, 1),
            -2,
            4,
        ...
        r.setParents("WARPTREE", "VOIDMETAL", "PRIMPEARL", "ROD_primal_staff")
        ...
        r.setParents("HOLLOWDAGGER")
            .setConcealed()
            .registerResearchItem();

        r = new TMResearchItem(
            "VOIDFORTRESS",
            new AspectList().add(Aspect.ARMOR, 5)
        ...
        r.setParentsHidden("ARMORVOIDFORTRESS", "ARMORFORTRESS")
        ...
        r.setParentsHidden("TAINTEDMAGIC", "GOGGLES")
            .setConcealed()
            .setSecondary()
        ...
        r.setParentsHidden("ELDRITCHMINOR")
        ...
        r = new TMResearchItem(
            "VOIDBLOOD",
            new AspectList().add(Aspect.VOID, 14)
        ...
        r.setParentsHidden("PRIMPEARL", "BOOTSTRAVELLER", "SHADOWCLOTH", "ARMORVOIDFORTRESS")
            .setConcealed()
            .setParents("TMELDRITCHMAJOR")
            .registerResearchItem();
        ...
        r = new TMResearchItem(
            "BREAKPEARL",
            TaintedMagicHelper.getPrimals(4)
        ...
        r = new TMResearchItem(
            "SKYSALT",
            new AspectList().add(TaintedMagicHelper.getPrimals(4))
        ...
        r.setPages(
            new ResearchPage("1"),
            infusionPage("ItemThaumicDisassembler"),
            arcanePage("ItemMaterial:6"),
            new ResearchPage("2"));
        r.setParentsHidden("THAUMIUM", "VOIDMETAL", "PRIMPEARL")
            .setConcealed()
            .setParents("TMELDRITCHMAJOR")
            .registerResearchItem();
        ...
        r.setParentsHidden("ENCHFABRIC", "ESSENTIACRYSTAL", "ELDRITCHMINOR")
        ...
        r.setParentsHidden("CAP_gold", "ENCHFABRIC")
            .setConcealed()
            .setSecondary()
            .registerResearchItem();
        ...
        r.setParentsHidden("VOIDMETAL", "PRIMALCRUSHER", "UNBALANCEDSHARDS", "HOLLOWDAGGER")
            .setConcealed()
            .setParents("CREATION")
            .registerResearchItem();
        ...
        r.setParentsHidden("ARMORFORTRESS")
            .setConcealed()
            .registerResearchItem();
        ...
        r = new TMResearchItem(
            ...
            3,
            6);
        r.setPages(new ResearchPage("1"), infusionPage("ItemSlashBladePrimal"));
        r.setParents("PRIMALBLADE", "INFUSION")
            .setConcealed()
            .registerResearchItem();
        ...
        r.setParentsHidden("THAUMIUMKATANA")
        ...
        r.setParentsHidden("VOIDMETALKATANA")
        ...
        r = new TMResearchItem(
            "ELDRITCHFOCUS",
            new AspectList().add(Aspect.ELDRITCH, 22)
        ...
        r.setParentsHidden("FOCALMANIPULATION")
            .setConcealed()
        ...
        r = new TMResearchItem(
            "FOCUSSHOCKWAVE",
            new AspectList().add(Aspect.MAGIC, 20)
                .add(Aspect.ENTROPY, 12)
                .add(Aspect.AIR, 6)
        ...
        r = new TMResearchItem(
            "FOCUSSHARD",
            new AspectList().add(Aspect.CRYSTAL, 2)
                .add(Aspect.MAGIC, 4)
                .add(Aspect.MOTION, 6),
            6,
            1,
        ...
        r.setParentsHidden("INFUSION", "BOTTLETAINT")
        ...
        r = new TMResearchItem(
            "FLYTECHARM",
            new AspectList().add(Aspect.FLIGHT, 15)
                .add(Aspect.AIR, 20)
                .add(Aspect.SENSES, 8)
                .add(Aspect.MAGIC, 12),
            13,
        ...
        r = new TMResearchItem(
            "GATEKEY",
            new AspectList().add(Aspect.TRAVEL, 30)
        ...
        r = new TMResearchItem(
            ...
            new AspectList().add(Aspect.METAL, 100)
                .add(Aspect.GREED, 100)
                .add(Aspect.DARKNESS, 100),
            0,
            4, // 坐标 (0, 4) 位于暗影套 (0, 3) 的正下方
            new ItemStack(ItemRegistry.ItemGoldenShadowFortressHelmet),
            20, // 复杂度 20
            50 // 扭曲值 50（禁忌知识）
        );
        r.setPages(
            new ResearchPage("1"), // 文本页，对应 tm.text.GOLDENSHADOWFORTRESS.1
            infusionPage("ItemGoldenShadowFortressHelmet"),
            infusionPage("ItemGoldenShadowFortressChestplate"),
            infusionPage("ItemGoldenShadowFortressLeggings"));
        r.setParents("SHADOWFORTRESS") // 前置：暗影要塞套
            .setConcealed()
            .registerResearchItem();
        ...
        r = new TMResearchItem(
            ...
            new AspectList().add(Aspect.WEAPON, 100)
                .add(Aspect.GREED, 100)
                .add(Aspect.DARKNESS, 100),
            0,
            6, // 坐标 (0, 6) 位于暗影要塞之刃 (0, 5) 的正下方
            new ItemStack(ItemRegistry.ItemKatana, 1, 3),
            20, // 复杂度 20
            50 // 扭曲值 50
        );
        r.setPages(
            new ResearchPage("1"), // 文本页，对应 tm.text.GOLDENSHADOWMETALKATANA.1
            infusionPage("ItemKatana:3"));
        r.setParents("SHADOWMETALKATANA") // 前置：暗影要塞之刃
            .setConcealed()
            .registerResearchItem();
