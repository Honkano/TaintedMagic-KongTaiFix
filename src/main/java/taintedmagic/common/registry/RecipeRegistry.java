...
public class RecipeRegistry {
    ...
    private static void initCrafting() {
        ...
        GameRegistry.addRecipe(
            new ItemStack(ItemRegistry.ItemMaterial, 9, 8),
            "A",
            'A',
            new ItemStack(ItemRegistry.ItemMaterial, 1, 0));
        ...
        // Warpwood Planks
        GameRegistry.addRecipe(
            new ItemStack(BlockRegistry.BlockWarpwoodPlanks, 4),
            "A",
            'A',
        ...
        ResearchRegistry.recipes.put(
            "ItemShadowmetalPick",
            GameRegistry.addShapedRecipe(
                new ItemStack(ItemRegistry.ItemShadowmetalPick),
                "AAA",
                " B ",
                " B ",
                'A',
        ...
        ResearchRegistry.recipes.put(
            "ItemShadowmetalAxe",
            GameRegistry.addShapedRecipe(
                new ItemStack(ItemRegistry.ItemShadowmetalAxe),
                "AA",
                "AB",
                " B",
                'A',
        ...
        ResearchRegistry.recipes.put(
            ...
            GameRegistry.addShapedRecipe(
                new ItemStack(ItemRegistry.ItemShadowmetalSpade),
                "A",
                "B",
                "B",
                'A',
        ...
        ResearchRegistry.recipes.put(
            "ItemShadowmetalHoe",
            GameRegistry.addShapedRecipe(
                new ItemStack(ItemRegistry.ItemShadowmetalHoe),
                "AA",
                " B",
                " B",
                'A',
    ...
    private static void initInfusion() {
        ...
        ResearchRegistry.recipes.put(
            ...
            ThaumcraftApi.addInfusionCraftingRecipe(
                ...
                6,
                new AspectList().add(Aspect.AIR, 35)
                    .add(Aspect.MOTION, 42)
        ...
        ResearchRegistry.recipes.put(
            ...
            ThaumcraftApi.addInfusionCraftingRecipe(
                ...
                8,
                new AspectList().add(Aspect.WEAPON, 65)
                    .add(Aspect.ELDRITCH, 46)
                    .add(Aspect.DARKNESS, 16)
                    .add(Aspect.METAL, 60)
                    .add(Aspect.VOID, 56),
                new ItemStack(ConfigItems.itemSwordVoid),
                new ItemStack[] { new ItemStack(ItemRegistry.ItemMaterial, 1, 5),
                    new ItemStack(ConfigItems.itemShard, 1, 0), new ItemStack(ConfigItems.itemShard, 1, 1),
                    new ItemStack(ConfigItems.itemShard, 1, 2), new ItemStack(ConfigItems.itemShard, 1, 6),
        ...
        ResearchRegistry.recipes.put(
            ...
            ThaumcraftApi.addInfusionCraftingRecipe(
                ...
                new AspectList().add(Aspect.WEAPON, 32)
                    ...
                    .add(Aspect.VOID, 32),
                new ItemStack(ConfigItems.itemSwordVoid),
                new ItemStack[] { new ItemStack(ItemRegistry.ItemCrimsonBlood),
        ...
        ResearchRegistry.recipes.put(
            ...
            ThaumcraftApi.addInfusionCraftingRecipe(
                "VOIDSASH",
                new ItemStack(ItemRegistry.ItemVoidwalkerSash, 1),
                7,
                new AspectList().add(Aspect.VOID, 56)
                    .add(Aspect.MAGIC, 40)
                    .add(Aspect.ARMOR, 76)
        ...
        ResearchRegistry.recipes.put(
            ...
            ThaumcraftApi.addInfusionCraftingRecipe(
                ...
                8,
                TaintedMagicHelper.getPrimals(55),
        ...
        ResearchRegistry.recipes.put(
            ...
            ThaumcraftApi.addInfusionCraftingRecipe(
                "ROD_warpwood",
                new ItemStack(ItemRegistry.ItemWandRod),
                8,
                new AspectList().add(Aspect.ELDRITCH, 65)
                    .add(Aspect.DARKNESS, 30)
                    .add(Aspect.TREE, 12)
                    .add(Aspect.MAGIC, 45)
                    .add(Aspect.AURA, 35),
                new ItemStack(BlockRegistry.BlockWarpwoodLog),
                new ItemStack[] { new ItemStack(ItemRegistry.ItemMaterial, 1, 9),
                    new ItemStack(ItemRegistry.ItemMaterial), new ItemStack(ItemRegistry.ItemMaterial, 1, 3),
                    new ItemStack(ConfigItems.itemResource, 1, 16), new ItemStack(ConfigItems.itemZombieBrain),
                    new ItemStack(ItemRegistry.ItemMaterial), new ItemStack(ItemRegistry.ItemMaterial, 1, 3),
                    new ItemStack(ConfigItems.itemResource, 1, 16) }));

        // Void Fortress Helm Goggles
        ResearchRegistry.recipes.put(
            "ItemVoidFortressHelmet:goggles",
            ThaumcraftApi.addInfusionCraftingRecipe(
                "HELMGOGGLES",
                new Object[] { "goggles", new NBTTagByte((byte) 1) },
                5,
                new AspectList().add(Aspect.SENSES, 32)
                    .add(Aspect.AURA, 16)
                    .add(Aspect.ARMOR, 16),
        ...
        ResearchRegistry.recipes.put(
            "ItemVoidFortressHelmet:mask0",
            ThaumcraftApi.addInfusionCraftingRecipe(
                "MASKGRINNINGDEVIL",
                new Object[] { "mask", new NBTTagInt(0) },
                8,
                new AspectList().add(Aspect.MIND, 64)
                    .add(Aspect.HEAL, 64)
                    .add(Aspect.ARMOR, 16),
                new ItemStack(ItemRegistry.ItemVoidFortressHelmet, 1, OreDictionary.WILDCARD_VALUE),
        ...
        ResearchRegistry.recipes.put(
            "ItemVoidFortressHelmet:mask2",
            ThaumcraftApi.addInfusionCraftingRecipe(
                "MASKSIPPINGFIEND",
                new Object[] { "mask", new NBTTagInt(2) },
                8,
                new AspectList().add(Aspect.UNDEAD, 64)
                    .add(Aspect.LIFE, 64)
                    .add(Aspect.ARMOR, 16),
                new ItemStack(ItemRegistry.ItemVoidFortressHelmet, 1, OreDictionary.WILDCARD_VALUE),
        ...
        ResearchRegistry.recipes.put(
            ...
            ThaumcraftApi.addInfusionCraftingRecipe(
                "VOIDFORTRESS",
                new ItemStack(ItemRegistry.ItemVoidFortressChestplate),
                6,
                new AspectList().add(Aspect.METAL, 24)
                    .add(Aspect.ARMOR, 24)
                    .add(Aspect.MAGIC, 8)
        ...
        ResearchRegistry.recipes.put(
            ...
            ThaumcraftApi.addInfusionCraftingRecipe(
                "VOIDFORTRESS",
                new ItemStack(ItemRegistry.ItemVoidFortressLeggings),
                6,
                new AspectList().add(Aspect.METAL, 24)
                    .add(Aspect.ARMOR, 20)
                    .add(Aspect.MAGIC, 8)
        ...
        ResearchRegistry.recipes.put(
            ...
            ThaumcraftApi.addInfusionCraftingRecipe(
                ...
                3,
                new AspectList().add(Aspect.ELDRITCH, 35)
        ...
        ResearchRegistry.recipes.put(
            ...
            ThaumcraftApi.addInfusionCraftingRecipe(
                "CAP_shadowmetal",
                new ItemStack(ItemRegistry.ItemWandCap),
                8,
                new AspectList().add(Aspect.ELDRITCH, 55)
                    .add(Aspect.DARKNESS, 47)
                    .add(Aspect.MAGIC, 52)
                    .add(Aspect.METAL, 45)
                    .add(Aspect.VOID, 55),
                new ItemStack(ConfigItems.itemWandCap, 1, 7),
                new ItemStack[] { new ItemStack(ItemRegistry.ItemMaterial, 1, 3),
                    new ItemStack(ItemRegistry.ItemMaterial), new ItemStack(ConfigItems.itemResource, 1, 16),
                    new ItemStack(ItemRegistry.ItemMaterial), new ItemStack(ItemRegistry.ItemMaterial, 1, 9),
                    new ItemStack(ItemRegistry.ItemMaterial), new ItemStack(ConfigItems.itemResource, 1, 16),
                    new ItemStack(ItemRegistry.ItemMaterial) }));
        ...
        ResearchRegistry.recipes.put(
            ...
            ThaumcraftApi.addInfusionCraftingRecipe(
                ...
                4,
                new AspectList().add(Aspect.TAINT, 45)
                    .add(Aspect.LIFE, 24)
                ...
                new ItemStack[] { new ItemStack(ConfigItems.itemResource, 1, 11),
                    new ItemStack(ItemRegistry.ItemMaterial, 1, 4), new ItemStack(ConfigItems.itemBottleTaint),
                    new ItemStack(ItemRegistry.ItemMaterial, 1, 4), new ItemStack(ConfigItems.itemResource, 1, 11),
                    new ItemStack(ItemRegistry.ItemMaterial, 1, 4), new ItemStack(ConfigItems.itemBottleTaint),
        ...
        ResearchRegistry.recipes.put(
            ...
            ThaumcraftApi.addInfusionCraftingRecipe(
                "KNIGHTROBES",
                new ItemStack(ItemRegistry.ItemMaterial, 9, 7),
                2,
        ...
        ResearchRegistry.recipes.put(
            ...
            ThaumcraftApi.addInfusionCraftingRecipe(
                ...
                8,
                new AspectList().add(Aspect.DARKNESS, 42)
                    .add(Aspect.VOID, 56)
                    .add(Aspect.ELDRITCH, 38)
                    .add(Aspect.ARMOR, 60)
                    .add(Aspect.TRAVEL, 45),
        ...
        ResearchRegistry.recipes.put(
            ...
            ThaumcraftApi.addInfusionCraftingRecipe(
                "SKYSALT",
                new ItemStack(ItemRegistry.ItemSalis, 3, 0),
                7,
                new AspectList().add(Aspect.AURA, 20)
                    .add(Aspect.WEATHER, 30)
                    .add(Aspect.WATER, 30),
        ...
        ResearchRegistry.recipes.put(
            ...
            ThaumcraftApi.addInfusionCraftingRecipe(
                "TIMESALT",
                new ItemStack(ItemRegistry.ItemSalis, 3, 1),
                7,
                new AspectList().add(Aspect.AURA, 20)
                    .add(Aspect.LIGHT, 30)
                    .add(Aspect.DARKNESS, 30),
        ...
        ResearchRegistry.recipes.put(
            "ItemThaumicDisassembler",
            ThaumcraftApi.addInfusionCraftingRecipe(
                "THAUMICDISASSEMBLER",
                new ItemStack(ItemRegistry.ItemThaumicDisassembler),
                3,
                new AspectList().add(Aspect.METAL, 22)
                    .add(Aspect.TOOL, 24)
                    .add(Aspect.WEAPON, 14)
                    .add(Aspect.MECHANISM, 12),
                new ItemStack(ItemRegistry.ItemMaterial, 1, 6),
                new ItemStack[] { new ItemStack(ItemRegistry.ItemMaterial, 1, 10),
                    new ItemStack(ConfigItems.itemPickVoid), new ItemStack(ConfigItems.itemResource, 1, 2),
                    new ItemStack(ConfigItems.itemShovelVoid), new ItemStack(Items.diamond),
                    new ItemStack(ConfigItems.itemSwordVoid), new ItemStack(ConfigItems.itemResource, 1, 2),
                    new ItemStack(ConfigItems.itemAxeVoid) }));

        // Shadow Fortress Helm Goggles
        ResearchRegistry.recipes.put(
            "ItemShadowFortressHelmet:goggles",
            ThaumcraftApi.addInfusionCraftingRecipe(
                "HELMGOGGLES",
                new Object[] { "goggles", new NBTTagByte((byte) 1) },
                5,
        ...
        ResearchRegistry.recipes.put(
            "ItemShadowFortressHelmet:mask0",
            ThaumcraftApi.addInfusionCraftingRecipe(
                "MASKGRINNINGDEVIL",
                new Object[] { "mask", new NBTTagInt(0) },
                8,
        ...
        ResearchRegistry.recipes.put(
            "ItemShadowFortressHelmet:mask1",
            ThaumcraftApi.addInfusionCraftingRecipe(
                "MASKANGRYGHOST",
                new Object[] { "mask", new NBTTagInt(1) },
                8,
        ...
        ResearchRegistry.recipes.put(
            "ItemShadowFortressHelmet:mask2",
            ThaumcraftApi.addInfusionCraftingRecipe(
                "MASKSIPPINGFIEND",
                new Object[] { "mask", new NBTTagInt(2) },
                8,
        ...
        ResearchRegistry.recipes.put(
            "ItemShadowFortressHelmet",
            ThaumcraftApi.addInfusionCraftingRecipe(
                "SHADOWFORTRESS",
                new ItemStack(ItemRegistry.ItemShadowFortressHelmet),
                7,
                new AspectList().add(Aspect.METAL, 28)
                    .add(Aspect.ARMOR, 20)
                    .add(Aspect.MAGIC, 12)
                    .add(Aspect.DARKNESS, 30)
                    .add(Aspect.VOID, 22),
                ...
                new ItemStack[] { new ItemStack(ItemRegistry.ItemMaterial, 1, 0),
                    new ItemStack(ItemRegistry.ItemMaterial, 1, 0), new ItemStack(Items.iron_ingot),
                    new ItemStack(Items.iron_ingot), new ItemStack(Items.emerald) }));

        // Shadow Fortress Chestplate
        ResearchRegistry.recipes.put(
            "ItemShadowFortressChestplate",
            ThaumcraftApi.addInfusionCraftingRecipe(
                "SHADOWFORTRESS",
                new ItemStack(ItemRegistry.ItemShadowFortressChestplate),
                7,
                new AspectList().add(Aspect.METAL, 38)
                    .add(Aspect.ARMOR, 26)
                    .add(Aspect.MAGIC, 18)
                    .add(Aspect.DARKNESS, 34)
                    .add(Aspect.VOID, 26),
                new ItemStack(ConfigItems.itemChestVoid),
                new ItemStack[] { new ItemStack(ItemRegistry.ItemMaterial, 1, 0),
        ...
        ResearchRegistry.recipes.put(
            "ItemShadowFortressLeggings",
            ThaumcraftApi.addInfusionCraftingRecipe(
                "SHADOWFORTRESS",
                new ItemStack(ItemRegistry.ItemShadowFortressLeggings),
                7,
                new AspectList().add(Aspect.METAL, 32)
                    .add(Aspect.ARMOR, 24)
                    .add(Aspect.MAGIC, 16)
                    .add(Aspect.DARKNESS, 32)
                    .add(Aspect.VOID, 24),
        ...
        ResearchRegistry.recipes.put(
            ...
            ThaumcraftApi.addInfusionCraftingRecipe(
                ...
                3,
                new AspectList().add(Aspect.METAL, 42)
                    .add(Aspect.WEAPON, 45)
                    .add(Aspect.MAGIC, 22),
        ...
        ResearchRegistry.recipes.put(
            ...
            ThaumcraftApi.addInfusionCraftingRecipe(
                ...
                6,
                new AspectList().add(Aspect.METAL, 52)
        ...
        ResearchRegistry.recipes.put(
            ...
            ThaumcraftApi.addInfusionCraftingRecipe(
                ...
                7,
                new AspectList().add(Aspect.METAL, 62)
                    .add(Aspect.WEAPON, 65)
                    .add(Aspect.MAGIC, 42)
                    .add(Aspect.VOID, 16)
                    .add(Aspect.DARKNESS, 46),
                new ItemStack(ItemRegistry.ItemShadowmetalSword),
        ...
        ResearchRegistry.recipes.put(
            ...
            ThaumcraftApi.addInfusionCraftingRecipe(
                "FLYTECHARM",
                new ItemStack(ItemRegistry.ItemFlyteCharm, 1, 0),
                7,
                new AspectList().add(Aspect.FLIGHT, 86)
                    .add(Aspect.AURA, 56)
                    .add(Aspect.SENSES, 25)
                    .add(Aspect.MAGIC, 48)
                    .add(Aspect.ENERGY, 65),
        ...
        ResearchRegistry.recipes.put(
            ...
            ThaumcraftApi.addInfusionCraftingRecipe(
                "GATEKEY",
                new ItemStack(ItemRegistry.ItemGateKey, 1, 0),
                7,
        ...
        // Void Metal Goggles
        ResearchRegistry.recipes.put(
            "ItemVoidmetalGoggles",
            ThaumcraftApi.addInfusionCraftingRecipe(
                "VOIDGOGGLES",
                new ItemStack(ItemRegistry.ItemVoidmetalGoggles),
                5,
                new AspectList().add(Aspect.VOID, 40)
                    .add(Aspect.SENSES, 35)
                    .add(Aspect.ARMOR, 20),
        ...
        ResearchRegistry.recipes.put(
            ...
            ThaumcraftApi.addInfusionCraftingRecipe(
                ...
                1,
                new AspectList().add(Aspect.LIGHT, 35)
                    .add(Aspect.SENSES, 25)
                    .add(Aspect.AURA, 10),
                new ItemStack(ConfigItems.itemBaubleBlanks, 1, 1),
                new ItemStack[] { new ItemStack(ItemRegistry.ItemFocusLumos),
                    new ItemStack(ConfigItems.itemResource, 1, 6), new ItemStack(Items.gold_ingot),
                    new ItemStack(ConfigItems.itemResource, 1, 14), new ItemStack(ConfigItems.itemResource, 1, 6),
                    new ItemStack(Items.gold_ingot) }));
         ...
         */
        ResearchRegistry.recipes.put(
            "ItemKatanaThaumium:inscription0",
            ThaumcraftApi.addInfusionCraftingRecipe(
                "INSCRIPTIONFIRE",
                new Object[] { ItemKatana.TAG_INSCRIPTION, new NBTTagInt(0) },
                8,
        ...
        ResearchRegistry.recipes.put(
            "ItemKatanaThaumium:inscription1",
            ThaumcraftApi.addInfusionCraftingRecipe(
                "INSCRIPTIONTHUNDER",
                new Object[] { ItemKatana.TAG_INSCRIPTION, new NBTTagInt(1) },
                8,
                new AspectList().add(Aspect.AIR, 64)
                    .add(Aspect.WEATHER, 64)
                    .add(Aspect.WEAPON, 16),
                new ItemStack(ItemRegistry.ItemKatana, 1, 0),
                new ItemStack[] { new ItemStack(ItemRegistry.ItemFocusShockwave),
                    new ItemStack(ConfigItems.itemShard, 1, 0), new ItemStack(Items.feather), new ItemStack(Blocks.tnt),
                    new ItemStack(ConfigItems.itemShard, 1, 5), new ItemStack(Items.gunpowder) }));

        ResearchRegistry.recipes.put(
            "ItemKatanaThaumium:inscription2",
            ThaumcraftApi.addInfusionCraftingRecipe(
                "INSCRIPTIONHEAL",
                new Object[] { ItemKatana.TAG_INSCRIPTION, new NBTTagInt(2) },
                8,
    ...
    private static void initArcane() {
        ...
        ResearchRegistry.recipes.put(
            ...
            ThaumcraftApi.addShapelessArcaneCraftingRecipe(
                ...
                new ItemStack(ItemRegistry.ItemCrimsonBlood),
        ...
        ResearchRegistry.recipes.put(
            ...
            ThaumcraftApi.addArcaneCraftingRecipe(
                ...
                TaintedMagicHelper.getPrimals(120),
                "  A",
                " B ",
                "B  ",
                'A',
        ...
        ResearchRegistry.recipes.put(
            ...
            ThaumcraftApi.addShapelessArcaneCraftingRecipe(
                ...
                TaintedMagicHelper.getPrimals(1),
        ...
        ResearchRegistry.recipes.put(
            ...
            ThaumcraftApi.addArcaneCraftingRecipe(
                "HOLLOWDAGGER",
                new ItemStack(ItemRegistry.ItemHollowDagger),
                new AspectList().add(Aspect.ENTROPY, 85),
                "  A",
                " BD",
                "C  ",
                'A',
        ...
        ResearchRegistry.recipes.put(
            ...
            ThaumcraftApi.addArcaneCraftingRecipe(
                ...
                new AspectList().add(Aspect.EARTH, 55)
                    .add(Aspect.FIRE, 55)
                    .add(Aspect.ENTROPY, 55)
                    .add(Aspect.ORDER, 55),
                "AAA",
                "ABA",
                'A',
        ...
        ResearchRegistry.recipes.put(
            ...
            ThaumcraftApi.addArcaneCraftingRecipe(
                "FOCUSSHARD",
                new ItemStack(ItemRegistry.ItemFocusVisShard),
                new AspectList().add(Aspect.AIR, 46)
                    .add(Aspect.ENTROPY, 38)
                    .add(Aspect.ORDER, 22),
                "BDC",
                "DAD",
                "CDB",
        ...
        ResearchRegistry.recipes.put(
            ...
            ThaumcraftApi.addArcaneCraftingRecipe(
                ...
                new AspectList().add(Aspect.AIR, 52)
                    .add(Aspect.FIRE, 56)
                    .add(Aspect.ORDER, 28),
                "BDC",
                "DAD",
        ...
        ResearchRegistry.recipes.put(
            ...
            ThaumcraftApi.addShapelessArcaneCraftingRecipe(
                "BREAKPEARL",
                new ItemStack(ItemRegistry.ItemMaterial, 3, 9),
        ...
        ResearchRegistry.recipes.put(
            ...
            ThaumcraftApi.addShapelessArcaneCraftingRecipe(
                "BREAKPEARL",
                new ItemStack(ItemRegistry.ItemMaterial, 3, 10),
        ...
        ResearchRegistry.recipes.put(
            ...
            ThaumcraftApi.addShapelessArcaneCraftingRecipe(
                "CREATIONSHARD",
                new ItemStack(ItemRegistry.ItemMaterial, 9, 11),
                new AspectList().add(Aspect.ENTROPY, 99),
                new ItemStack(ItemRegistry.ItemMaterial, 1, 5)));
        ...
        ResearchRegistry.recipes.put(
            ...
            ThaumcraftApi.addArcaneCraftingRecipe(
                ...
                new ItemStack(ItemRegistry.ItemCrimsonBlood),
                'B',
                new ItemStack(ItemRegistry.ItemMaterial, 1, 10),
                'C',
    ...
    private static void initCrucible() {
        ...
        ResearchRegistry.recipes.put(
            ...
            ThaumcraftApi.addCrucibleRecipe(
                ...
                new ItemStack(ItemRegistry.ItemMaterial, 1, 3),
                new ItemStack(ConfigItems.itemShard, 1, 6),
                new AspectList().merge(Aspect.ELDRITCH, 4)));
        ...
        ResearchRegistry.recipes.put(
            ...
            ThaumcraftApi.addCrucibleRecipe(
                ...
                new ItemStack(ItemRegistry.ItemMaterial, 1, 4),
                new ItemStack(ConfigItems.itemShard, 1, 6),
                new AspectList().merge(Aspect.TAINT, 4)));
        ...
        ResearchRegistry.recipes.put(
            ...
            ThaumcraftApi.addCrucibleRecipe(
                ...
                new ItemStack(ItemRegistry.ItemMaterial, 1, 0),
                new ItemStack(Items.iron_ingot),
                new AspectList().merge(Aspect.DARKNESS, 3)
                    .merge(Aspect.METAL, 7)
        ...
        ResearchRegistry.recipes.put(
            ...
            ThaumcraftApi.addCrucibleRecipe(
                ...
                new AspectList().merge(Aspect.MAGIC, 3)
                    .merge(Aspect.POISON, 1)));
        ...
        // Primal Cursed Blade —— 元始妖刃
        ResearchRegistry.recipes.put(
            "ItemSlashBladePrimal",
            ThaumcraftApi.addInfusionCraftingRecipe(
                "PRIMALCURSEDBLADE",
                ItemSlashBladePrimal.createPrimalCursedBlade(), // ← 改这里
                20, // 最高复杂度
                new AspectList().add(Aspect.WEAPON, 800)
                    .add(Aspect.ELDRITCH, 480)
                    .add(Aspect.DARKNESS, 320)
                    .add(Aspect.VOID, 400)
                    .add(Aspect.METAL, 320)
                    .add(Aspect.MAGIC, 240)
                    .add(Aspect.AURA, 160),
                new ItemStack(ItemRegistry.ItemPrimalBlade),
                new ItemStack[] { new ItemStack(ItemRegistry.ItemShadowmetalSword),
                    new ItemStack(ItemRegistry.ItemShadowmetalSword), new ItemStack(ItemRegistry.ItemShadowmetalSword),
                    new ItemStack(ItemRegistry.ItemHollowDagger), new ItemStack(ItemRegistry.ItemSalis, 1, 0),
                    new ItemStack(ItemRegistry.ItemSalis, 1, 1), new ItemStack(ItemRegistry.ItemFlyteCharm),
                    new ItemStack(ItemRegistry.ItemMaterial, 1, 5), // 创世碎片
                    new ItemStack(ItemRegistry.ItemMaterial, 1, 5), // 创世碎片
                    new ItemStack(ItemRegistry.ItemMaterial, 1, 5), // 创世碎片
                    new ItemStack(ItemRegistry.ItemKatana, 1, 2)
        ...
        // ================== 黄金暗影堡垒套 与 黄金暗影要塞之刃 注魔配方 ==================

        // 黄金暗影头盔（核心：暗影头盔 + 扭曲揭示护目镜 + 虚空揭示护目镜 + 10黄金块 + 4暗影锭）
        ResearchRegistry.recipes.put(
            "ItemGoldenShadowFortressHelmet",
            ThaumcraftApi.addInfusionCraftingRecipe(
                "GOLDENSHADOWFORTRESS",
                new ItemStack(ItemRegistry.ItemGoldenShadowFortressHelmet),
                20, // 注魔风险（20点，超级危险）
                new AspectList().add(Aspect.METAL, 120)
                    .add(Aspect.ARMOR, 100)
                    .add(Aspect.DARKNESS, 150)
                    .add(Aspect.VOID, 120)
                    .add(Aspect.ELDRITCH, 100)
                    .add(Aspect.SENSES, 150) // 感官（透镜）
                    .add(Aspect.AURA, 100) // 灵气（看节点）
                    .add(Aspect.MAGIC, 120)
                    .add(Aspect.GREED, 100), // 贪婪（黄金）
                new ItemStack(ItemRegistry.ItemShadowFortressHelmet),
                new ItemStack[] {
                    // 10个黄金块
                    ...
                    // 两个核心护目镜
                    new ItemStack(ItemRegistry.ItemWarpedGoggles, 1, OreDictionary.WILDCARD_VALUE),
                    new ItemStack(ItemRegistry.ItemVoidmetalGoggles, 1, OreDictionary.WILDCARD_VALUE) }));

        // 黄金暗影胸甲（核心：暗影胸甲 + 10黄金块 + 8暗影锭）
        ResearchRegistry.recipes.put(
            "ItemGoldenShadowFortressChestplate",
            ThaumcraftApi.addInfusionCraftingRecipe(
                "GOLDENSHADOWFORTRESS",
                new ItemStack(ItemRegistry.ItemGoldenShadowFortressChestplate),
                20,
                new AspectList().add(Aspect.METAL, 150)
                    .add(Aspect.ARMOR, 150)
                    .add(Aspect.DARKNESS, 150)
                    .add(Aspect.VOID, 120)
                    .add(Aspect.MAGIC, 120)
                    .add(Aspect.GREED, 100),
                new ItemStack(ItemRegistry.ItemShadowFortressChestplate),
                new ItemStack[] {
                    // 10个黄金块
                    new ItemStack(Blocks.gold_block), new ItemStack(Blocks.gold_block),
        ...
        // 黄金暗影护腿（核心：暗影护腿 + 10黄金块 + 7暗影锭）
        ResearchRegistry.recipes.put(
            "ItemGoldenShadowFortressLeggings",
            ThaumcraftApi.addInfusionCraftingRecipe(
                "GOLDENSHADOWFORTRESS",
                new ItemStack(ItemRegistry.ItemGoldenShadowFortressLeggings),
                20,
                new AspectList().add(Aspect.METAL, 130)
                    .add(Aspect.ARMOR, 120)
                    .add(Aspect.DARKNESS, 120)
                    .add(Aspect.VOID, 100)
                    .add(Aspect.GREED, 100),
                new ItemStack(ItemRegistry.ItemShadowFortressLeggings),
                new ItemStack[] {
        ...
        // 黄金暗影要塞之刃（核心：暗影要塞之刃 + 10黄金块 + 4黑曜石 + 绿宝石）
        ResearchRegistry.recipes.put(
            "ItemKatana:3",
            ThaumcraftApi.addInfusionCraftingRecipe(
                "GOLDENSHADOWMETALKATANA",
                new ItemStack(ItemRegistry.ItemKatana, 1, 3),
                20,
                new AspectList().add(Aspect.WEAPON, 200)
                    .add(Aspect.METAL, 150)
                    .add(Aspect.DARKNESS, 150)
                    .add(Aspect.VOID, 120)
                    .add(Aspect.ELDRITCH, 100)
                    .add(Aspect.GREED, 100)
                ...
                new ItemStack[] {
                    ...
                    // 绿宝石和暗影锭
                    new ItemStack(Items.emerald), new ItemStack(ItemRegistry.ItemMaterial, 1, 0),
                    new ItemStack(ItemRegistry.ItemMaterial, 1, 0), new ItemStack(ItemRegistry.ItemMaterial, 1, 5), // 创世碎片
                    new ItemStack(ItemRegistry.ItemMaterial, 1, 5), // 创世碎片
                    new ItemStack(ItemRegistry.ItemMaterial, 1, 5), // 创世碎片
                    new ItemStack(ItemRegistry.ItemMaterial, 1, 0), new ItemStack(ItemRegistry.ItemMaterial, 1, 0),
                    new ItemStack(ItemRegistry.ItemMaterial, 1, 0), new ItemStack(ItemRegistry.ItemMaterial, 1, 0) }));
