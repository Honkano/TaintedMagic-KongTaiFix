...
import taintedmagic.common.handler.AchievementHandler;
...
public class CommonProxy {
    ...
    public void registerHandlers() {
        ...
        MinecraftForge.EVENT_BUS.register(new AchievementHandler()); // <-- 新增
        FMLCommonHandler.instance()
            .bus()
            .register(new TMEventHandler());
    }
