...
public class RecipeVoidBlood implements IRecipe {
    ...
    public ItemStack getCraftingResult(final InventoryCrafting inv) {
        ...
        for (int i = 0; i < inv.getSizeInventory(); i++) {
            ...
            } else if (inv.getStackInSlot(i) != null && inv.getStackInSlot(i)
                .getItem() instanceof ItemVoidBlood) {
                    blood = inv.getStackInSlot(i);
                }
        }
        if (armor != null && blood != null
            && (armor.getTagCompound() == null || armor.getTagCompound() != null && !armor.getTagCompound()
                .getBoolean("voidtouched"))) {
            copy = armor.copy();
